...
class importerObj:
    def __init__(self, drug, source=None, masterDf=None):
        ...
        self.source = source
        self.masterDf = None
        self.rawFields = ["Week", "TRx_Quantity", "NRx_Quantity"]
        self.updatedFields = [
            "Week",
            "Year",
            "Month",
    ...
    def import_from_raw_weekly_data(self):
        ...
        df = pd.read_csv(
            f"drugData/{self.drug}_Weekly_Raw_Data.csv",
            parse_dates=["Week"],
    ...
    def import_from_updated_weekly_data(self):
        ...
        df = pd.read_csv(
            f"drugData/{self.drug}_Weekly_Updated_Data.csv",
            parse_dates=["Week"],
            skipinitialspace=True,
            usecols=fields,
        )
    ...
    def create_Normalized_Rx(self, df):
        ...
        df["Normalized_TRx"] = df.apply(
            lambda row: int(row.TRx_Quantity / self.rx_quantity), axis=1
        )
        df["Normalized_NRx"] = df.apply(
            lambda row: int(row.NRx_Quantity / self.rx_quantity), axis=1
        )
        df["Normalized_RRx"] = df.apply(
            lambda row: int(row.Normalized_TRx - row.Normalized_NRx), axis=1
        )
        return df
    ...
    def create_Wow_Growth(self, df):
        ...
        df["TRx_Wow_Growth"] = round(
            (df["Normalized_TRx"] - df["Normalized_TRx"].shift(-1))
            / df["Normalized_TRx"].shift(-1),
            4,
        )
        df["NRx_Wow_Growth"] = round(
            (df["Normalized_NRx"] - df["Normalized_NRx"].shift(-1))
            / df["Normalized_NRx"].shift(-1),
            4,
        )
        df["RRx_Wow_Growth"] = round(
            (df["Normalized_RRx"] - df["Normalized_RRx"].shift(-1))
            / df["Normalized_RRx"].shift(-1),
            4,
        )
        return df
    ...
    def create_Rx_Moving_Averages(self, df):
        df["Four_Week_MA_TRx"] = round(
            (
                df["Normalized_TRx"]
                + df["Normalized_TRx"].shift(-1)
                + df["Normalized_TRx"].shift(-2)
                + df["Normalized_TRx"].shift(-3)
            )
            / 4
        )
        df["Four_Week_MA_NRx"] = round(
            (
                df["Normalized_NRx"]
                + df["Normalized_NRx"].shift(-1)
                + df["Normalized_NRx"].shift(-2)
                + df["Normalized_NRx"].shift(-3)
            )
            / 4
        )
        df["Four_Week_MA_RRx"] = round(
            (
                df["Normalized_RRx"]
                + df["Normalized_RRx"].shift(-1)
                + df["Normalized_RRx"].shift(-2)
                + df["Normalized_RRx"].shift(-3)
            )
            / 4
        )

        df["Eight_Week_MA_TRx"] = round(
            (
                df["Normalized_TRx"]
                + df["Normalized_TRx"].shift(-1)
                + df["Normalized_TRx"].shift(-2)
                + df["Normalized_TRx"].shift(-3)
                + df["Normalized_TRx"].shift(-4)
                + df["Normalized_TRx"].shift(-5)
                + df["Normalized_TRx"].shift(-6)
                + df["Normalized_TRx"].shift(-7)
            )
            / 8
        )
        df["Eight_Week_MA_NRx"] = round(
            (
                df["Normalized_NRx"]
                + df["Normalized_NRx"].shift(-1)
                + df["Normalized_NRx"].shift(-2)
                + df["Normalized_NRx"].shift(-3)
                + df["Normalized_NRx"].shift(-4)
                + df["Normalized_NRx"].shift(-5)
                + df["Normalized_NRx"].shift(-6)
                + df["Normalized_NRx"].shift(-7)
            )
            / 8
        )
        df["Eight_Week_MA_RRx"] = round(
            (
                df["Normalized_RRx"]
                + df["Normalized_RRx"].shift(-1)
                + df["Normalized_RRx"].shift(-2)
                + df["Normalized_RRx"].shift(-3)
                + df["Normalized_RRx"].shift(-4)
                + df["Normalized_RRx"].shift(-5)
                + df["Normalized_RRx"].shift(-6)
                + df["Normalized_RRx"].shift(-7)
            )
            / 8
        )

        df["Thirteen_Week_MA_TRx"] = round(
            (
                df["Normalized_TRx"]
                + df["Normalized_TRx"].shift(-1)
                + df["Normalized_TRx"].shift(-2)
                ...
                + df["Normalized_TRx"].shift(-6)
                + df["Normalized_TRx"].shift(-7)
                + df["Normalized_TRx"].shift(-8)
                + df["Normalized_TRx"].shift(-9)
                + df["Normalized_TRx"].shift(-10)
                + df["Normalized_TRx"].shift(-11)
                + df["Normalized_TRx"].shift(-12)
            )
            / 13
        )
        df["Thirteen_Week_MA_NRx"] = round(
            (
                df["Normalized_NRx"]
                + df["Normalized_NRx"].shift(-1)
                + df["Normalized_NRx"].shift(-2)
                ...
                + df["Normalized_NRx"].shift(-6)
                + df["Normalized_NRx"].shift(-7)
                + df["Normalized_NRx"].shift(-8)
                + df["Normalized_NRx"].shift(-9)
                + df["Normalized_NRx"].shift(-10)
                + df["Normalized_NRx"].shift(-11)
                + df["Normalized_NRx"].shift(-12)
            )
            / 13
        )
        df["Thirteen_Week_MA_RRx"] = round(
            (
                df["Normalized_RRx"]
                + df["Normalized_RRx"].shift(-1)
                + df["Normalized_RRx"].shift(-2)
                ...
                + df["Normalized_RRx"].shift(-6)
                + df["Normalized_RRx"].shift(-7)
                + df["Normalized_RRx"].shift(-8)
                + df["Normalized_RRx"].shift(-9)
                + df["Normalized_RRx"].shift(-10)
                + df["Normalized_RRx"].shift(-11)
                + df["Normalized_RRx"].shift(-12)
            )
            / 13
        )
    ...
    def create_WoW_Moving_averages(self, df):
        df["Four_Week_MA_TRx_WoW_Growth"] = round(
            (
                df["TRx_Wow_Growth"]
                + df["TRx_Wow_Growth"].shift(-1)
                + df["TRx_Wow_Growth"].shift(-2)
                + df["TRx_Wow_Growth"].shift(-3)
            )
            / 4,
            4,
        )
        df["Four_Week_MA_NRx_WoW_Growth"] = round(
            (
                df["NRx_Wow_Growth"]
                + df["NRx_Wow_Growth"].shift(-1)
                + df["NRx_Wow_Growth"].shift(-2)
                + df["NRx_Wow_Growth"].shift(-3)
            )
            / 4,
            4,
        )
        df["Four_Week_MA_RRx_WoW_Growth"] = round(
            (
                df["RRx_Wow_Growth"]
                + df["RRx_Wow_Growth"].shift(-1)
                + df["RRx_Wow_Growth"].shift(-2)
                + df["RRx_Wow_Growth"].shift(-3)
            )
            / 4,
            4,
        )

        df["Eight_Week_MA_TRx_WoW_Growth"] = round(
            (
                df["TRx_Wow_Growth"]
                + df["TRx_Wow_Growth"].shift(-1)
                + df["TRx_Wow_Growth"].shift(-2)
                + df["TRx_Wow_Growth"].shift(-3)
                + df["TRx_Wow_Growth"].shift(-4)
                + df["TRx_Wow_Growth"].shift(-5)
                + df["TRx_Wow_Growth"].shift(-6)
                + df["TRx_Wow_Growth"].shift(-7)
            )
            / 8,
            4,
        )
        df["Eight_Week_MA_NRx_WoW_Growth"] = round(
            (
                df["NRx_Wow_Growth"]
                + df["NRx_Wow_Growth"].shift(-1)
                + df["NRx_Wow_Growth"].shift(-2)
                + df["NRx_Wow_Growth"].shift(-3)
                + df["NRx_Wow_Growth"].shift(-4)
                + df["NRx_Wow_Growth"].shift(-5)
                + df["NRx_Wow_Growth"].shift(-6)
                + df["NRx_Wow_Growth"].shift(-7)
            )
            / 8,
            4,
        )
        df["Eight_Week_MA_RRx_WoW_Growth"] = round(
            (
                df["RRx_Wow_Growth"]
                + df["RRx_Wow_Growth"].shift(-1)
                + df["RRx_Wow_Growth"].shift(-2)
                + df["RRx_Wow_Growth"].shift(-3)
                + df["RRx_Wow_Growth"].shift(-4)
                + df["RRx_Wow_Growth"].shift(-5)
                + df["RRx_Wow_Growth"].shift(-6)
                + df["RRx_Wow_Growth"].shift(-7)
            )
            / 8,
            4,
        )

        df["Thirteen_Week_MA_TRx_WoW_Growth"] = round(
            (
                df["TRx_Wow_Growth"]
                + df["TRx_Wow_Growth"].shift(-1)
                + df["TRx_Wow_Growth"].shift(-2)
                ...
                + df["TRx_Wow_Growth"].shift(-6)
                + df["TRx_Wow_Growth"].shift(-7)
                + df["TRx_Wow_Growth"].shift(-8)
                + df["TRx_Wow_Growth"].shift(-9)
                + df["TRx_Wow_Growth"].shift(-10)
                + df["TRx_Wow_Growth"].shift(-11)
                + df["TRx_Wow_Growth"].shift(-12)
            )
            / 13,
            4,
        )
        df["Thirteen_Week_MA_NRx_WoW_Growth"] = round(
            (
                df["NRx_Wow_Growth"]
                + df["NRx_Wow_Growth"].shift(-1)
                + df["NRx_Wow_Growth"].shift(-2)
                ...
                + df["NRx_Wow_Growth"].shift(-6)
                + df["NRx_Wow_Growth"].shift(-7)
                + df["NRx_Wow_Growth"].shift(-8)
                + df["NRx_Wow_Growth"].shift(-9)
                + df["NRx_Wow_Growth"].shift(-10)
                + df["NRx_Wow_Growth"].shift(-11)
                + df["NRx_Wow_Growth"].shift(-12)
            )
            / 13,
            4,
        )
        df["Thirteen_Week_MA_RRx_WoW_Growth"] = round(
            (
                df["RRx_Wow_Growth"]
                + df["RRx_Wow_Growth"].shift(-1)
                + df["RRx_Wow_Growth"].shift(-2)
                ...
                + df["RRx_Wow_Growth"].shift(-6)
                + df["RRx_Wow_Growth"].shift(-7)
                + df["RRx_Wow_Growth"].shift(-8)
                + df["RRx_Wow_Growth"].shift(-9)
                + df["RRx_Wow_Growth"].shift(-10)
                + df["RRx_Wow_Growth"].shift(-11)
                + df["RRx_Wow_Growth"].shift(-12)
            )
            / 13,
            4,
        )

...
class drugObj:
    ...
    def generateAvailableGraphsDict(self):
        availableGraphs = {
            "graph_normalizedTRxAndAllMAs": {
                "function": self.graph_normalizedTRxAndAllMAs,
                "figName": self.normalizedTRxAndAllMAsChart,
            },
            "graph_normalizedTRx": {
                "function": self.graph_normalizedTRx,
                "figName": self.normalizedTRxChart,
            },
            "graph_fourWeekMATRx": {
                "function": self.graph_fourWeekMATRx,
                "figName": self.fourWeekMATRxChart,
            },
            "graph_eightWeekMATRx": {
                "function": self.graph_eightWeekMATRx,
                "figName": self.eightWeekMATRxChart,
            },
            "graph_thirteenWeekMATRx": {
                "function": self.graph_thirteenWeekMATRx,
                "figName": self.thirteenWeekMATRxChart,
            },
            "graph_normalizedTRxLog": {
                "function": self.graph_normalizedTRxLog,
                "figName": self.normalizedTRxLogChart,
            },
            "graph_normalizedNRx": {
                "function": self.graph_normalizedNRx,
                "figName": self.normalizedNRxChart,
            },
            "graph_fourWeekMANRx": {
                "function": self.graph_fourWeekMANRx,
                "figName": self.fourWeekMANRxChart,
            },
            "graph_eightWeekMANRx": {
                "function": self.graph_eightWeekMANRx,
                "figName": self.eightWeekMANRxChart,
            },
            "graph_thirteenWeekMANRx": {
                "function": self.graph_thirteenWeekMANRx,
                "figName": self.thirteenWeekMANRxChart,
            },
            "graph_normalizedNRxLog": {
                "function": self.graph_normalizedNRxLog,
                "figName": self.normalizedNRxLogChart,
            },
            "graph_normalizedRRx": {
                "function": self.graph_normalizedRRx,
                "figName": self.normalizedRRxChart,
            },
            "graph_fourWeekMARRx": {
                "function": self.graph_fourWeekMARRx,
                "figName": self.fourWeekMARRxChart,
            },
            "graph_eightWeekMARRx": {
                "function": self.graph_eightWeekMARRx,
                "figName": self.eightWeekMARRxChart,
            },
            "graph_thirteenWeekMARRx": {
                "function": self.graph_thirteenWeekMARRx,
                "figName": self.thirteenWeekMARRxChart,
            },
            "graph_normalizedRRxLog": {
                "function": self.graph_normalizedRRxLog,
                "figName": self.normalizedRRxLogChart,
            },
            "graph_trxWowGrowth": {
                "function": self.graph_trxWowGrowth,
                "figName": self.trxWowGrowthChart,
            },
            "graph_fourWeekMATRxWoWGrowth": {
                "function": self.graph_fourWeekMATRxWoWGrowth,
                "figName": self.fourWeekMATRxWoWGrowthChart,
            },
            "graph_eightWeekMATRxWoWGrowth": {
                "function": self.graph_eightWeekMATRxWoWGrowth,
                "figName": self.eightWeekMATRxWoWGrowthChart,
            },
            "graph_thirteenWeekMATRxWoWGrowth": {
                "function": self.graph_thirteenWeekMATRxWoWGrowth,
                "figName": self.thirteenWeekMATRxWoWGrowthChart,
            },
            "graph_nrxWowGrowth": {
                "function": self.graph_nrxWowGrowth,
                "figName": self.nrxWowGrowthChart,
            },
            "graph_fourWeekMANRxWoWGrowth": {
                "function": self.graph_fourWeekMANRxWoWGrowth,
                "figName": self.fourWeekMANRxWoWGrowthChart,
            },
            "graph_eightWeekMANRxWoWGrowth": {
                "function": self.graph_eightWeekMANRxWoWGrowth,
                "figName": self.eightWeekMANRxWoWGrowthChart,
            },
            "graph_thirteenWeekMANRxWoWGrowth": {
                "function": self.graph_thirteenWeekMANRxWoWGrowth,
                "figName": self.thirteenWeekMANRxWoWGrowthChart,
            },
            "graph_rrxWowGrowth": {
                "function": self.graph_rrxWowGrowth,
                "figName": self.rrxWowGrowthChart,
            },
            "graph_fourWeekMARRxWoWGrowth": {
                "function": self.graph_fourWeekMARRxWoWGrowth,
                "figName": self.fourWeekMARRxWoWGrowthChart,
            },
            "graph_eightWeekMARRxWoWGrowth": {
                "function": self.graph_eightWeekMARRxWoWGrowth,
                "figName": self.eightWeekMARRxWoWGrowthChart,
            },
            "graph_thirteenWeekMARRxWoWGrowth": {
                "function": self.graph_thirteenWeekMARRxWoWGrowth,
                "figName": self.thirteenWeekMARRxWoWGrowthChart,
            },
            "graphNormalizedAllRx": {
                "function": self.graphNormalizedAllRx,
                "figName": self.normalizedAllRxChart,
            },
        }
    ...
    def add_new_data_weekly(self, month, day, year, trx_quantity, nrx_quantity):
        ...
        if df["Week"][0] == week:
            ...
            trx_wow_growth = (normalized_trx - df["Normalized_TRx"][0]) / df[
                "Normalized_TRx"
            ][0]
            nrx_wow_growth = (normalized_nrx - df["Normalized_NRx"][0]) / df[
                "Normalized_NRx"
            ][0]
            rrx_wow_growth = (normalized_rrx - df["Normalized_RRx"][0]) / df[
                "Normalized_RRx"
            ][0]
            # date should be changed to week I think
            week_of_year = (
                1
                if (week.month == 1 and week.day >= 4 and week.day < 11)
                else df["Week_Of_Year"][0] + 1
            )
            ...
            thirteen_week_ma_trx = round(
                (
                    ...
                    + df["Normalized_TRx"][8]
                    + df["Normalized_TRx"][9]
                    + df["Normalized_TRx"][10]
                    + df["Normalized_TRx"][11]
                )
                / 13
            )
            thirteen_week_ma_nrx = round(
                (
                    normalized_nrx
                    + df["Normalized_NRx"][0]
                    + df["Normalized_NRx"][1]
                    ...
                    + df["Normalized_NRx"][8]
                    + df["Normalized_NRx"][9]
                    + df["Normalized_NRx"][10]
                    + df["Normalized_NRx"][11]
                )
                / 13
            )
            thirteen_week_ma_rrx = round(
                (
                    normalized_rrx
                    + df["Normalized_RRx"][0]
                    + df["Normalized_RRx"][1]
                    ...
                    + df["Normalized_RRx"][8]
                    + df["Normalized_RRx"][9]
                    + df["Normalized_RRx"][10]
                    + df["Normalized_RRx"][11]
                )
                / 13
            )
            ...
            eight_week_ma_trx_wow_growth = round(
                (
                    trx_wow_growth
                    + df["TRx_Wow_Growth"][0]
                    + df["TRx_Wow_Growth"][1]
            ...
            eight_week_ma_nrx_wow_growth = round(
                (
                    nrx_wow_growth
                    + df["NRx_Wow_Growth"][0]
                    + df["NRx_Wow_Growth"][1]
            ...
            eight_week_ma_rrx_wow_growth = round(
                (
                    rrx_wow_growth
                    + df["RRx_Wow_Growth"][0]
                    + df["RRx_Wow_Growth"][1]
            ...
            thirteen_week_ma_trx_wow_growth = round(
                (
                    trx_wow_growth
                    + df["TRx_Wow_Growth"][0]
                    + df["TRx_Wow_Growth"][1]
                    ...
                    + df["TRx_Wow_Growth"][8]
                    + df["TRx_Wow_Growth"][9]
                    + df["TRx_Wow_Growth"][10]
                    + df["TRx_Wow_Growth"][11]
                )
                / 13,
                4,
            )
            thirteen_week_ma_nrx_wow_growth = round(
                (
                    nrx_wow_growth
                    + df["NRx_Wow_Growth"][0]
                    + df["NRx_Wow_Growth"][1]
                    ...
                    + df["NRx_Wow_Growth"][8]
                    + df["NRx_Wow_Growth"][9]
                    + df["NRx_Wow_Growth"][10]
                    + df["NRx_Wow_Growth"][11]
                )
                / 13,
                4,
            )
            thirteen_week_ma_rrx_wow_growth = round(
                (
                    rrx_wow_growth
                    + df["RRx_Wow_Growth"][0]
                    + df["RRx_Wow_Growth"][1]
                    ...
                    + df["RRx_Wow_Growth"][8]
                    + df["RRx_Wow_Growth"][9]
                    + df["RRx_Wow_Growth"][10]
                    + df["RRx_Wow_Growth"][11]
                )
                / 13,
                4,
            )
    ...
    def graphNormalizedAllRx(self, weeks, predict):
        self.normalizedAllRxChart = graphObj(
            self.drug,
            self.masterDf,
            weeks,
            "Week",
            ...
            yLabel="Vascepa All Prescriptions",
        )
        # implement prediction

    def graph_normalizedTRxLog(self, weeks, predict):
        self.normalizedTRxLogChart = graphObj(
            self.drug,
            self.masterDf,
            weeks,
            "Week",
    ...
    def graph_normalizedRRxLog(self, weeks, predict):
        self.normalizedRRxLogChart = graphObj(
            self.drug,
            self.masterDf,
            weeks,
            "Week",
    ...
    def graph_thirteenWeekMATRx(self, weeks, predict):
        self.thirteenWeekMATRxChart = graphObj(
            self.drug,
            self.masterDf,
            weeks,
            "Week",
    ...
    def graph_thirteenWeekMARRx(self, weeks, predict):
        self.thirteenWeekMARRxChart = graphObj(
            self.drug,
            self.masterDf,
            weeks,
            "Week",
    ...
    def graph_normalizedTRxAndAllMAs(self, weeks, predict):
        self.normalizedTRxAndAllMAsChart = graphObj(
            self.drug,
            self.masterDf,
            weeks,
            "Week",
            ...
            ["scatter", "plot", "plot", "plot"],
            yLabel="Vascepa TRx and All Moving Averages",
        )
        # implement prediction

    # new:
    def graph_fourWeekMATRxWoWGrowth(self, weeks, predict):
        self.fourWeekMATRxWoWGrowthChart = graphObj(
            self.drug,
            self.masterDf,
            weeks,
            "Week",
        ...
        if predict == True:
            ...
            self.fourWeekMATRxWoWGrowthChart.generateChart(
                ["plot"],
                predictionDf["Week"],
                [predictionDf["Four_Week_MA_TRx_WoW_Growth"]],
            )

    def graph_fourWeekMANRxWoWGrowth(self, weeks, predict):
        self.fourWeekMANRxWoWGrowthChart = graphObj(
            self.drug,
            self.masterDf,
            weeks,
            "Week",
        ...
        if predict == True:
            ...
            self.fourWeekMANRxWoWGrowthChart.generateChart(
                ["plot"],
                predictionDf["Week"],
                [predictionDf["Four_Week_MA_NRx_WoW_Growth"]],
            )

    def graph_fourWeekMARRxWoWGrowth(self, weeks, predict):
        self.fourWeekMARRxWoWGrowthChart = graphObj(
            self.drug,
            self.masterDf,
            weeks,
            "Week",
        ...
        if predict == True:
            ...
            self.fourWeekMARRxWoWGrowthChart.generateChart(
                ["plot"],
                predictionDf["Week"],
                [predictionDf["Four_Week_MA_RRx_WoW_Growth"]],
            )

    def graph_eightWeekMATRxWoWGrowth(self, weeks, predict):
        self.eightWeekMATRxWoWGrowthChart = graphObj(
            self.drug,
            self.masterDf,
            weeks,
            "Week",
        ...
        if predict == True:
            ...
            self.eightWeekMATRxWoWGrowthChart.generateChart(
                ["plot"],
                predictionDf["Week"],
                [predictionDf["Eight_Week_MA_TRx_WoW_Growth"]],
            )

    def graph_eightWeekMANRxWoWGrowth(self, weeks, predict):
        self.eightWeekMANRxWoWGrowthChart = graphObj(
            self.drug,
            self.masterDf,
            weeks,
            "Week",
        ...
        if predict == True:
            ...
            self.eightWeekMANRxWoWGrowthChart.generateChart(
                ["plot"],
                predictionDf["Week"],
                [predictionDf["Eight_Week_MA_NRx_WoW_Growth"]],
            )
    ...
    def graph_thirteenWeekMATRxWoWGrowth(self, weeks, predict):
        self.thirteenWeekMATRxWoWGrowthChart = graphObj(
            self.drug,
            self.masterDf,
            weeks,
            "Week",
        ...
        if predict == True:
            ...
            self.thirteenWeekMATRxWoWGrowthChart.generateChart(
                ["plot"],
                predictionDf["Week"],
                [predictionDf["Thirteen_Week_MA_TRx_WoW_Growth"]],
            )
    ...
    def graph_thirteenWeekMARRxWoWGrowth(self, weeks, predict):
        self.thirteenWeekMARRxWoWGrowthChart = graphObj(
            self.drug,
            self.masterDf,
            weeks,
            "Week",
        ...
        if predict == True:
            ...
            self.thirteenWeekMARRxWoWGrowthChart.generateChart(
                ["plot"],
                predictionDf["Week"],
                [predictionDf["Thirteen_Week_MA_RRx_WoW_Growth"]],
            )

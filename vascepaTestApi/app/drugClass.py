...
class drugObj:
    ...
    def __init__(self, drug, weeks, source=None, predict=False, weeksToTrainOn=None):
        ...
        self.weeksToTrainOn = round(
            len(self.masterDf) * 0.75) if weeksToTrainOn is None else weeksToTrainOn
    ...
    def add_new_data_weekly(self, month, day, year, trx_quantity, nrx_quantity):
        ...
        if df["Week"][0] == week:
            ...
            trx_wow_growth = (
                normalized_trx - df["Normalized_TRx"][0])/df["Normalized_TRx"][0]
            nrx_wow_growth = (
                normalized_nrx - df["Normalized_NRx"][0])/df["Normalized_NRx"][0]
            rrx_wow_growth = (
                normalized_rrx - df["Normalized_RRx"][0])/df["Normalized_RRx"][0]
            # date should be changed to week I think
            week_of_year = 1 if (week.month == 1 and week.day >=
                                 4 and week.day < 11) else df['Week_Of_Year'][0]+1
            four_week_ma_trx = round(
                (normalized_trx + df["Normalized_TRx"][0] + df["Normalized_TRx"][1] + df["Normalized_TRx"][2])/4)
            four_week_ma_nrx = round(
                (normalized_nrx + df["Normalized_NRx"][0] + df["Normalized_NRx"][1] + df["Normalized_NRx"][2])/4)
            four_week_ma_rrx = round(
                (normalized_rrx + df["Normalized_RRx"][0] + df["Normalized_RRx"][1] + df["Normalized_RRx"][2])/4)
            eight_week_ma_trx = round((normalized_trx + df["Normalized_TRx"][0] + df["Normalized_TRx"][1] + df["Normalized_TRx"]
                                       [2] + df["Normalized_TRx"][3] + df["Normalized_TRx"][4] + df["Normalized_TRx"][5] + df["Normalized_TRx"][6])/8)
            eight_week_ma_nrx = round((normalized_nrx + df["Normalized_NRx"][0] + df["Normalized_NRx"][1] + df["Normalized_NRx"]
                                       [2] + df["Normalized_NRx"][3] + df["Normalized_NRx"][4] + df["Normalized_NRx"][5] + df["Normalized_NRx"][6])/8)
            eight_week_ma_rrx = round((normalized_rrx + df["Normalized_RRx"][0] + df["Normalized_RRx"][1] + df["Normalized_RRx"]
                                       [2] + df["Normalized_RRx"][3] + df["Normalized_RRx"][4] + df["Normalized_RRx"][5] + df["Normalized_RRx"][6])/8)
            thirteen_week_ma_trx = round((normalized_trx + df["Normalized_TRx"][0] + df["Normalized_TRx"][1] + df["Normalized_TRx"][2] + df["Normalized_TRx"][3] + df["Normalized_TRx"][4] +
                                          df["Normalized_TRx"][5] + df["Normalized_TRx"][6] + df["Normalized_TRx"][7] + df["Normalized_TRx"][8] + df["Normalized_TRx"][9] + df["Normalized_TRx"][10] + df["Normalized_TRx"][11])/13)
            thirteen_week_ma_nrx = round((normalized_nrx + df["Normalized_NRx"][0] + df["Normalized_NRx"][1] + df["Normalized_NRx"][2] + df["Normalized_NRx"][3] + df["Normalized_NRx"][4] +
                                          df["Normalized_NRx"][5] + df["Normalized_NRx"][6] + df["Normalized_NRx"][7] + df["Normalized_NRx"][8] + df["Normalized_NRx"][9] + df["Normalized_NRx"][10] + df["Normalized_NRx"][11])/13)
            thirteen_week_ma_rrx = round((normalized_rrx + df["Normalized_RRx"][0] + df["Normalized_RRx"][1] + df["Normalized_RRx"][2] + df["Normalized_RRx"][3] + df["Normalized_RRx"][4] +
                                          df["Normalized_RRx"][5] + df["Normalized_RRx"][6] + df["Normalized_RRx"][7] + df["Normalized_RRx"][8] + df["Normalized_RRx"][9] + df["Normalized_RRx"][10] + df["Normalized_RRx"][11])/13)
            four_week_ma_trx_wow_growth = round(
                (trx_wow_growth + df["TRx_Wow_Growth"][0] + df["TRx_Wow_Growth"][1] + df["TRx_Wow_Growth"][2])/4, 4)
            four_week_ma_nrx_wow_growth = round(
                (nrx_wow_growth + df["NRx_Wow_Growth"][0] + df["NRx_Wow_Growth"][1] + df["NRx_Wow_Growth"][2])/4, 4)
            four_week_ma_rrx_wow_growth = round(
                (rrx_wow_growth + df["RRx_Wow_Growth"][0] + df["RRx_Wow_Growth"][1] + df["RRx_Wow_Growth"][2])/4, 4)
            eight_week_ma_trx_wow_growth = round((trx_wow_growth + df["TRx_Wow_Growth"][0] + df["TRx_Wow_Growth"][1] + df["TRx_Wow_Growth"]
                                                  [2] + df["TRx_Wow_Growth"][3] + df["TRx_Wow_Growth"][4] + df["TRx_Wow_Growth"][5] + df["TRx_Wow_Growth"][6])/8, 4)
            eight_week_ma_nrx_wow_growth = round((nrx_wow_growth + df["NRx_Wow_Growth"][0] + df["NRx_Wow_Growth"][1] + df["NRx_Wow_Growth"]
                                                  [2] + df["NRx_Wow_Growth"][3] + df["NRx_Wow_Growth"][4] + df["NRx_Wow_Growth"][5] + df["NRx_Wow_Growth"][6])/8, 4)
            eight_week_ma_rrx_wow_growth = round((rrx_wow_growth + df["RRx_Wow_Growth"][0] + df["RRx_Wow_Growth"][1] + df["RRx_Wow_Growth"]
                                                  [2] + df["RRx_Wow_Growth"][3] + df["RRx_Wow_Growth"][4] + df["RRx_Wow_Growth"][5] + df["RRx_Wow_Growth"][6])/8, 4)
            thirteen_week_ma_trx_wow_growth = round((trx_wow_growth + df["TRx_Wow_Growth"][0] + df["TRx_Wow_Growth"][1] + df["TRx_Wow_Growth"][2] + df["TRx_Wow_Growth"][3] + df["TRx_Wow_Growth"][4] +
                                                     df["TRx_Wow_Growth"][5] + df["TRx_Wow_Growth"][6] + df["TRx_Wow_Growth"][7] + df["TRx_Wow_Growth"][8] + df["TRx_Wow_Growth"][9] + df["TRx_Wow_Growth"][10] + df["TRx_Wow_Growth"][11])/13, 4)
            thirteen_week_ma_nrx_wow_growth = round((nrx_wow_growth + df["NRx_Wow_Growth"][0] + df["NRx_Wow_Growth"][1] + df["NRx_Wow_Growth"][2] + df["NRx_Wow_Growth"][3] + df["NRx_Wow_Growth"][4] +
                                                     df["NRx_Wow_Growth"][5] + df["NRx_Wow_Growth"][6] + df["NRx_Wow_Growth"][7] + df["NRx_Wow_Growth"][8] + df["NRx_Wow_Growth"][9] + df["NRx_Wow_Growth"][10] + df["NRx_Wow_Growth"][11])/13, 4)
            thirteen_week_ma_rrx_wow_growth = round((rrx_wow_growth + df["RRx_Wow_Growth"][0] + df["RRx_Wow_Growth"][1] + df["RRx_Wow_Growth"][2] + df["RRx_Wow_Growth"][3] + df["RRx_Wow_Growth"][4] +
                                                     df["RRx_Wow_Growth"][5] + df["RRx_Wow_Growth"][6] + df["RRx_Wow_Growth"][7] + df["RRx_Wow_Growth"][8] + df["RRx_Wow_Growth"][9] + df["RRx_Wow_Growth"][10] + df["RRx_Wow_Growth"][11])/13, 4)
    ...
    def graph_normalizedTRx(self, weeks, predict):
        ...
        """
        self.normalizedTRxChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                           "Normalized_TRx"], ["scatter"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Normalized_TRx", 52).predictionDf
            self.normalizedTRxPredictionDf = predictionDf
            self.normalizedTRxChart.generateChart(["scatter"], predictionDf["Week"], [
    ...
    def graph_normalizedNRx(self, weeks, predict):
        ...
        weeks: number of weeks to dispaly. The graph displays the 0th entry to the specified number of weeks. (int)
        """
        self.normalizedNRxChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                           "Normalized_NRx"], ["scatter"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Normalized_NRx", 52).predictionDf
            self.normalizedNRxPredictionDf = predictionDf
            self.normalizedNRxChart.generateChart(["scatter"], predictionDf["Week"], [
    ...
    def graph_normalizedRRx(self, weeks, predict):
        ...
        weeks: number of weeks to dispaly. The graph displays the 0th entry to the specified number of weeks. (int)
        """
        self.normalizedRRxChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                           "Normalized_RRx"], ["scatter"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Normalized_RRx", 52).predictionDf
            self.normalizedRRxPredictionDf = predictionDf
            self.normalizedRRxChart.generateChart(["scatter"], predictionDf["Week"], [
    ...
    def graph_trxWowGrowth(self, weeks, predict):
        ...
        """
        self.trxWowGrowthChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                          "TRx_Wow_Growth"], ["plot"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "TRx_Wow_Growth", 52).predictionDf
            self.trxWowGrowthChart.generateChart(["plot"], predictionDf["Week"], [
    ...
    def graph_nrxWowGrowth(self, weeks, predict):
        ...
        """
        self.nrxWowGrowthChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                          "NRx_Wow_Growth"], ["plot"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "NRx_Wow_Growth", 52).predictionDf
            self.nrxWowGrowthChart.generateChart(["plot"], predictionDf["Week"], [
    ...
    def graph_rrxWowGrowth(self, weeks, predict):
        ...
        """
        self.rrxWowGrowthChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                          "RRx_Wow_Growth"], ["plot"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "RRx_Wow_Growth", 52).predictionDf
            self.rrxWowGrowthChart.generateChart(["plot"], predictionDf["Week"], [
                                                 predictionDf["RRx_Wow_Growth"]])

    def graphNormalizedAllRx(self, weeks, predict):
        self.normalizedAllRxChart = graphObj(self.drug, self.masterDf, weeks, "Week", ["Normalized_TRx", "Normalized_NRx", "Normalized_RRx"], [
                                             "scatter", "scatter", "scatter"], yLabel="Vascepa All Prescriptions")
        # implement prediction

    def graph_normalizedTRxLog(self, weeks, predict):
        self.normalizedTRxLogChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                              "Normalized_TRx"], ["logy_plot"], yLabel="Normalized_TRx Log Scale")
        # might have wierd predict behavior
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Normalized_TRx", 52).predictionDf
            self.normalizedTRxLogChart.generateChart(["logy_plot"], predictionDf["Week"], [
                                                     predictionDf["Normalized_TRx"]])

    def graph_normalizedNRxLog(self, weeks, predict):
        self.normalizedNRxLogChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                              "Normalized_NRx"], ["logy_plot"], yLabel="Normalized_TRx Log Scale")
        # might have wierd predict behavior
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Normalized_NRx", 52).predictionDf
            self.normalizedNRxLogChart.generateChart(["logy_plot"], predictionDf["Week"], [
                                                     predictionDf["Normalized_NRx"]])

    def graph_normalizedRRxLog(self, weeks, predict):
        self.normalizedRRxLogChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                              "Normalized_RRx"], ["logy_plot"], yLabel="Normalized_TRx Log Scale")
        # might have wierd predict behavior
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Normalized_RRx", 52).predictionDf
            self.normalizedRRxLogChart.generateChart(["logy_plot"], predictionDf["Week"], [
                                                     predictionDf["Normalized_RRx"]])

    def graph_fourWeekMATRx(self, weeks, predict):
        self.fourWeekMATRxChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                           "Four_Week_MA_TRx"], ["scatter"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Four_Week_MA_TRx", 52).predictionDf
            self.fourWeekMATRxChart.generateChart(["scatter"], predictionDf["Week"], [
                                                  predictionDf["Four_Week_MA_TRx"]])

    def graph_fourWeekMANRx(self, weeks, predict):
        self.fourWeekMANRxChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                           "Four_Week_MA_NRx"], ["scatter"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Four_Week_MA_NRx", 52).predictionDf
            self.fourWeekMANRxChart.generateChart(["scatter"], predictionDf["Week"], [
                                                  predictionDf["Four_Week_MA_NRx"]])

    def graph_fourWeekMARRx(self, weeks, predict):
        self.fourWeekMARRxChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                           "Four_Week_MA_RRx"], ["scatter"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Four_Week_MA_RRx", 52).predictionDf
            self.fourWeekMARRxChart.generateChart(["scatter"], predictionDf["Week"], [
                                                  predictionDf["Four_Week_MA_RRx"]])

    def graph_eightWeekMATRx(self, weeks, predict):
        self.eightWeekMATRxChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                            "Eight_Week_MA_TRx"], ["scatter"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Eight_Week_MA_TRx", 52).predictionDf
            self.eightWeekMATRxChart.generateChart(["scatter"], predictionDf["Week"], [
                                                   predictionDf["Eight_Week_MA_TRx"]])

    def graph_eightWeekMANRx(self, weeks, predict):
        self.eightWeekMANRxChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                            "Eight_Week_MA_NRx"], ["scatter"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Eight_Week_MA_NRx", 52).predictionDf
            self.eightWeekMANRxChart.generateChart(["scatter"], predictionDf["Week"], [
                                                   predictionDf["Eight_Week_MA_NRx"]])

    def graph_eightWeekMARRx(self, weeks, predict):
        self.eightWeekMARRxChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                            "Eight_Week_MA_RRx"], ["scatter"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Eight_Week_MA_RRx", 52).predictionDf
            self.eightWeekMARRxChart.generateChart(["scatter"], predictionDf["Week"], [
                                                   predictionDf["Eight_Week_MA_RRx"]])

    def graph_thirteenWeekMATRx(self, weeks, predict):
        self.thirteenWeekMATRxChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                               "Thirteen_Week_MA_TRx"], ["scatter"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Thirteen_Week_MA_TRx", 52).predictionDf
            self.thirteenWeekMATRxChart.generateChart(["scatter"], predictionDf["Week"], [
                                                      predictionDf["Thirteen_Week_MA_TRx"]])

    def graph_thirteenWeekMANRx(self, weeks, predict):
        self.thirteenWeekMANRxChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                               "Thirteen_Week_MA_NRx"], ["scatter"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Thirteen_Week_MA_NRx", 52).predictionDf
            self.thirteenWeekMANRxChart.generateChart(["scatter"], predictionDf["Week"], [
                                                      predictionDf["Thirteen_Week_MA_NRx"]])

    def graph_thirteenWeekMARRx(self, weeks, predict):
        self.thirteenWeekMARRxChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                               "Thirteen_Week_MA_RRx"], ["scatter"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Thirteen_Week_MA_RRx", 52).predictionDf
            self.thirteenWeekMARRxChart.generateChart(["scatter"], predictionDf["Week"], [
                                                      predictionDf["Thirteen_Week_MA_RRx"]])

    def graph_normalizedTRxAndAllMAs(self, weeks, predict):
        self.normalizedTRxAndAllMAsChart = graphObj(self.drug, self.masterDf, weeks, "Week", ["Normalized_TRx", "Four_Week_MA_TRx", "Eight_Week_MA_TRx", "Thirteen_Week_MA_TRx"], [
                                                    "scatter", "plot", "plot", "plot"], yLabel="Vascepa TRx and All Moving Averages")
        # implement prediction

    # new:
    def graph_fourWeekMATRxWoWGrowth(self, weeks, predict):
        self.fourWeekMATRxWoWGrowthChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                                    "Four_Week_MA_TRx_WoW_Growth"], ["plot"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Four_Week_MA_TRx_WoW_Growth", 52).predictionDf
            self.fourWeekMATRxWoWGrowthChart.generateChart(
                ["plot"], predictionDf["Week"], [predictionDf["Four_Week_MA_TRx_WoW_Growth"]])

    def graph_fourWeekMANRxWoWGrowth(self, weeks, predict):
        self.fourWeekMANRxWoWGrowthChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                                    "Four_Week_MA_NRx_WoW_Growth"], ["plot"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Four_Week_MA_NRx_WoW_Growth", 52).predictionDf
            self.fourWeekMANRxWoWGrowthChart.generateChart(
                ["plot"], predictionDf["Week"], [predictionDf["Four_Week_MA_NRx_WoW_Growth"]])

    def graph_fourWeekMARRxWoWGrowth(self, weeks, predict):
        self.fourWeekMARRxWoWGrowthChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                                    "Four_Week_MA_RRx_WoW_Growth"], ["plot"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Four_Week_MA_RRx_WoW_Growth", 52).predictionDf
            self.fourWeekMARRxWoWGrowthChart.generateChart(
                ["plot"], predictionDf["Week"], [predictionDf["Four_Week_MA_RRx_WoW_Growth"]])

    def graph_eightWeekMATRxWoWGrowth(self, weeks, predict):
        self.eightWeekMATRxWoWGrowthChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                                     "Eight_Week_MA_TRx_WoW_Growth"], ["plot"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Eight_Week_MA_TRx_WoW_Growth", 52).predictionDf
            self.eightWeekMATRxWoWGrowthChart.generateChart(
                ["plot"], predictionDf["Week"], [predictionDf["Eight_Week_MA_TRx_WoW_Growth"]])

    def graph_eightWeekMANRxWoWGrowth(self, weeks, predict):
        self.eightWeekMANRxWoWGrowthChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                                     "Eight_Week_MA_NRx_WoW_Growth"], ["plot"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Eight_Week_MA_NRx_WoW_Growth", 52).predictionDf
            self.eightWeekMANRxWoWGrowthChart.generateChart(
                ["plot"], predictionDf["Week"], [predictionDf["Eight_Week_MA_NRx_WoW_Growth"]])

    def graph_eightWeekMARRxWoWGrowth(self, weeks, predict):
        self.eightWeekMARRxWoWGrowthChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                                     "Eight_Week_MA_RRx_WoW_Growth"], ["plot"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Eight_Week_MA_RRx_WoW_Growth", 52).predictionDf
            self.eightWeekMARRxWoWGrowthChart.generateChart(
                ["plot"], predictionDf["Week"], [predictionDf["Eight_Week_MA_RRx_WoW_Growth"]])

    def graph_thirteenWeekMATRxWoWGrowth(self, weeks, predict):
        self.thirteenWeekMATRxWoWGrowthChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                                        "Thirteen_Week_MA_TRx_WoW_Growth"], ["plot"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Thirteen_Week_MA_TRx_WoW_Growth", 52).predictionDf
            self.thirteenWeekMATRxWoWGrowthChart.generateChart(
                ["plot"], predictionDf["Week"], [predictionDf["Thirteen_Week_MA_TRx_WoW_Growth"]])

    def graph_thirteenWeekMANRxWoWGrowth(self, weeks, predict):
        self.thirteenWeekMANRxWoWGrowthChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                                        "Thirteen_Week_MA_NRx_WoW_Growth"], ["plot"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Thirteen_Week_MA_NRx_WoW_Growth", 52).predictionDf
            self.thirteenWeekMANRxWoWGrowthChart.generateChart(
                ["plot"], predictionDf["Week"], [predictionDf["Thirteen_Week_MA_NRx_WoW_Growth"]])

    def graph_thirteenWeekMARRxWoWGrowth(self, weeks, predict):
        self.thirteenWeekMARRxWoWGrowthChart = graphObj(self.drug, self.masterDf, weeks, "Week", [
                                                        "Thirteen_Week_MA_RRx_WoW_Growth"], ["plot"])
        if predict == True:
            predictionDf = modelObj(
                self.masterDf, self.weeksToTrainOn, "Thirteen_Week_MA_RRx_WoW_Growth", 52).predictionDf
            self.thirteenWeekMARRxWoWGrowthChart.generateChart(
                ["plot"], predictionDf["Week"], [predictionDf["Thirteen_Week_MA_RRx_WoW_Growth"]])
